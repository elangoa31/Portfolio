...
export function Hero() {
  ...
  useEffect(() => {
    ...
    const updateParallax = () => {
      ...
      setMouseOffset({
        x: Math.round(currentX * 3.5 * 10) / 10, // 2-5px parallax on portrait (Req 3 & 10)
    ...
    <section className="relative min-h-[92vh] flex items-center pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Right Column: Profile Photo with Subtle Halo & Parallax */}
          <div className="lg:col-span-5 order-1 lg:order-2 flex justify-center lg:justify-end">
            ...
            >
              ...
              <div className="relative aspect-square rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 bg-white/[0.03] shadow-[0_20px_50px_rgba(0,0,0,0.6)]">
                <img
                  src="/profile.jpeg"
                  onError={(e) => {
